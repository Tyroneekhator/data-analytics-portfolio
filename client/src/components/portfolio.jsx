...
/**
 * The main Portfolio component that acts as the container for the entire website.
 * It manages the application's state, handles all API interactions, and renders
 * the different sections and components of the portfolio.
 */
const Portfolio = () => {
  ...
  // useEffect to fetch the projects from the backend when the component first mounts.
  useEffect(() => {
    fetchProjects();
  }, []);

  /**
   * Fetches all projects from the backend API, handling loading and error states.
   */
  ...
  /**
   * Handles saving a new project or updating an existing one. It uses either POST or PUT
   * based on whether a project is being edited.
   * @param {object} projectData - The data for the project to be saved.
   */
   ...
   * @param {boolean} props.isAdmin - Flag to show/hide admin controls.
   * @param {function} props.onEdit - Callback for editing a project.
        ...
        <div className="mt-6 flex gap-4">
          ...
          {project.liveDemoUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-full font-semibold shadow-md hover:bg-purple-700 transition"
            >
  ...
  /**
   * A modal component for adding or editing a project.
   * @param {object} props - The component's properties.
   * @param {object} props.project - The project data to pre-fill the form, if editing.
